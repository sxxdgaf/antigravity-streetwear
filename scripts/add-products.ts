/**
 * Add products only (categories already exist)
 */
...
async function addProducts() {
  ...
  try {
    ...
    if (!categories || categories.length === 0) {
      console.log('❌ No categories found. Run the full seed first.');
      process.exit(1);
    }
    ...
    console.log('🚀 Go to http://localhost:3000 and refresh the page!\n');
